...
class InheritDesc(models.Model):
    ...
    """This function is used to pass the value from sale_order to Regular Invoivce"""
    ...
    """This function is used to pass the value from sale_order to Project and Task model"""
